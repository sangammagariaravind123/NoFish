...
st.markdown("Enter a URL below to analyze its risk level using our hybrid AI + Cybersecurity model.")
...
if check_btn and url_input.strip():
    ...
    path = log_result(url_input, prob, rule_score, trust_index, risk, rules)
